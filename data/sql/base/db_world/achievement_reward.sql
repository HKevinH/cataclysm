...
INSERT INTO `achievement_reward` (`entry`, `title_A`, `title_H`, `item`, `sender`, `subject`, `text`) VALUES
	...
	(5449, 0, 0, 60869, 32216, 'Achievement reward', ''),
	(5876, 0, 0, 71140, 32216, 'Achievement reward', ''),
	(5877, 0, 0, 71387, 32216, 'Achievement reward', ''),
	(5875, 0, 0, 54810, 32216, 'Achievement reward', ''),
	(5860, 0, 0, 0, 32216, 'Achievement reward', 'Dieses Item existiert zu diesem Patchstand noch nicht!'),
	(5859, 0, 0, 69854, 32216, 'Achievement reward', ''),
	(5866, 0, 0, 69213, 32216, 'Achievement reward', ''),
	(5879, 276, 276, 0, 0, '', ''),
	(5506, 227, 227, 0, 0, '', ''),
	(4845, 0, 0, 62900, 32216, 'Achievement reward', ''),
	(4853, 0, 0, 62901, 32216, 'Achievement reward', ''),
	(5828, 0, 0, 69230, 32216, 'Achievement reward', ''),
	(6169, 0, 0, 77068, 32216, 'Achievement reward', ''),
	(4854, 189, 189, 0, 0, '', ''),
	(4855, 190, 190, 0, 0, '', ''),
	(4856, 191, 191, 0, 0, '', ''),
	(5827, 267, 267, 0, 0, '', ''),
	...
	(6116, 285, 285, 0, 0, '', ''),
	(5767, 258, 258, 0, 0, '', ''),
	(5325, 0, 194, 70910, 32216, 'Achievement reward', ''),
	(5824, 0, 0, 70910, 32216, 'Achievement reward', ''),
	(5326, 0, 259, 70910, 32216, 'Achievement reward', ''),
	(5328, 193, 0, 70909, 32216, 'Achievement reward', ''),
	(5823, 0, 0, 70909, 32216, 'Achievement reward', ''),
	(5329, 260, 0, 70909, 32216, 'Achievement reward', ''),
	(5351, 0, 215, 0, 0, '', ''),
	(5338, 0, 217, 0, 0, '', ''),
	(5353, 0, 218, 0, 0, '', ''),
	(5340, 205, 0, 0, 0, '', ''),
