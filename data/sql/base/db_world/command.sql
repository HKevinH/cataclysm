...
INSERT INTO `command` (`name`, `security`, `help`) VALUES
	...
	('cooldown', 1, 'Syntax: .cooldown [#spell_id]\r\n\r\nRemove all (if spell_id not provided) or #spel_id spell cooldown from selected character or you (if no selection).'),
	...
	('modify reputation', 1, 'Syntax: .modify reputation #repId (#repvalue | $rankname [#delta])\nSets the selected players reputation with faction #repId to #repvalue or to $reprank.\nIf the reputation rank name is provided, the resulting reputation will be the lowest reputation for that rank plus the delta amount, if specified.\nYou can use \'.pinfo rep\' to list all known reputation ids, or use \'.lookup faction $name\' to locate a specific faction id.'),
	...
	('npc add formation', 2, 'Syntax: .npc add formation $leader\nAdd selected creature to a leader\'s formation.'),
	...
	('spell_regulator', 1, 'Syntax:'),
	('reload spell_regulator', 1, 'Syntax:');
